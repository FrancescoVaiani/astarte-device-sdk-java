...
public class AstarteDeviceAggregateDatastreamInterfaceTest {
    ...
    public void init() throws AstarteInvalidInterfaceException {
        ...
        aInterface = (AstarteDeviceAggregateDatastreamInterface)AstarteInterface.fromJSON(json, storage);
    }

    @Test
    public void validateAggregateTest() throws AstarteInvalidValueException, AstarteInterfaceMappingNotFoundException {
    ...
    @Test
    public void validateAggregateLTooFewPayloadTest() throws AstarteInterfaceMappingNotFoundException {
        Map<String, Object> payload = new HashMap<>();
        payload.put("uno", 1);
        try {
            aInterface.validatePayload("/test", payload, DateTime.now());
    ...
    @Test
    public void validateAggregateTimestampRequiredTest() throws AstarteInvalidValueException, AstarteInterfaceMappingNotFoundException {
        Map<String, Object> payload = new HashMap<>();
        payload.put("uno", 1);
        payload.put("due", 2);
        try {
